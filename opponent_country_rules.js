...
(function(global){
  ...
  const RUNTIME_LAYER_REGISTRY=Object.freeze([
    ...
    {id:'L01_CANONICAL_IDENTITY',contract:'raw entity -> canonical identity'},
    {id:'L02_CAPABILITY_REGISTRY',contract:'fields -> capabilities'},
    {id:'L03_WORLD_STATE_KERNEL',contract:'observations -> current state'},
    {id:'L04_DEPENDENCY_GRAPH',contract:'state -> dependency and causal links'},
    {id:'L05_DEMAND_ENGINE',contract:'state -> demand and requirements'},
    {id:'L06_SUPPLY_CAPACITY_ENGINE',contract:'state -> effective supply and capacity'},
    {id:'L07_NEED_GAP_PRESSURE_ENGINE',contract:'requirement vs availability -> pressure'},
    {id:'L08_SCENARIO_ENGINE',contract:'pressure/opportunity -> scenario'},
    {id:'L09_GOAL_PRIORITY_ENGINE',contract:'actor context -> persistent priorities'},
    {id:'L10_DECISION_ENGINE',contract:'candidate actions -> decision intent'},
    {id:'L11_FEASIBILITY_ENGINE',contract:'decision intent -> executable/not executable'},
    {id:'L12_PROJECT_ENGINE',contract:'physical change -> project lifecycle'},
    {id:'L13_TRANSACTION_ENGINE',contract:'economic/resource transfer -> transaction'},
    {id:'L14_TRADE_MARKET_ENGINE',contract:'market and trade state -> flows/prices/opportunities'},
    {id:'L15_FINANCE_ENGINE',contract:'revenue/liquidity/capital/debt -> financial state'},
    {id:'L16_INFRA_LOGISTICS_ENGINE',contract:'network capacity -> reachable supply'},
    {id:'L17_POPULATION_LABOR_ENGINE',contract:'demography -> labour and household state'},
    {id:'L18_TECH_PRODUCTIVITY_ENGINE',contract:'technology -> productivity/capability state'},
    {id:'L19_POLICY_INSTITUTION_ENGINE',contract:'policy/institutions -> constraints and effects'},
    {id:'L20_EVENT_SHOCK_ENGINE',contract:'event -> affected state nodes'},
    {id:'L21_CONSEQUENCE_ENGINE',contract:'executed action -> propagated effects'},
    {id:'L22_FORECAST_ENGINE',contract:'state + trends + commitments -> projection'},
    {id:'L23_ACTOR_MEMORY_ADAPTATION',contract:'decision/outcome -> actor memory and adaptation'},
    {id:'L24_MULTI_RATE_SCHEDULER',contract:'dependencies/events -> evaluation schedule'},
    {id:'L25_STATE_RECONCILIATION',contract:'state transitions -> invariant validation'},
    {id:'L26_EVIDENCE_TRACE',contract:'source -> rule/decision/execution lineage'},
    {id:'L27_RUNTIME_DEBUG',contract:'runtime telemetry -> deterministic diagnostics'}
  ]);
