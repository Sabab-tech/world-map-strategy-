...
window.OmegaCabinetUI = {
    ...
    getResource16CardsHtml() {
        ...
        const points = [
            ...
            { num: '02', id: 'p02', tag: 'FOUNDATION', icon: '📖', title: 'Canonical Commodity Ontology Matrix', bn: 'ক্যানোনিক্যাল রিসোর্সের রাসায়নিক ও ভৌত কাঠামো', desc: 'Canonical runtime resource IDs, physicochemical transformations, substitution metadata, and reserve classifications.', btnText: 'View Commodity Ontology', action: () => `window.ResourceMinistryEngine.openModal('${normKey}', 'matrix')`, border: '#38bdf8' },
            ...
            { num: '04', id: 'p04', tag: 'UPSTREAM', icon: '🗺️', title: 'Deposit Registry & Geocoded Mines', bn: 'খনিজ ডিপোজিট ও ভূতাত্ত্বিক ম্যাপিং', desc: 'Observed runtime deposits plus profile site references, with authority and data-completeness state shown explicitly.', btnText: 'Explore Geocoded Deposits', action: () => `window.ResourceMinistryEngine.openModal('${normKey}', 'deposits')`, border: '#ca8a04' },
