...
const diag=L.diagnostics();assert.equal(diag.externalLanguageFileDependency,false);assert.equal(diag.lexiconTotalWords,7756);assert.equal(diag.version,'5.2.0');
