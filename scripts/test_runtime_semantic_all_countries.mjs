...
const { default: brain } = await import('../offline_semantic_brain.js').catch(async () => ({ default: globalThis.OfflineSemanticBrain }));
const resources = [];
...
const examples = [
  'How many mines are in Bangladesh?',
  'How many mines are in India?',
  'Where are the mines in China?',
  'বাংলাদেশে কয়টি খনি আছে?',
  'ভারতে কয়টি খনি আছে?',
  'চীনে খনিগুলো কোথায় আছে?'
];
