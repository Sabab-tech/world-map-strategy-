/**
 * OMEGA REASONING DISPATCHER v2.0.1
 * Evidence-bound bridge between semantic routing and the existing 40-stage OS.
 * Stages 21-40 are distinct, dependency-aware evidence stages layered around
 * the existing cognitive stages. No new runtime file is required.
 */
  ...
  function runSpecialized(id,ctx,os){
    ...
    try{
      ...
      switch(id){
        ...
        case 39:{ctx.answerContract={evidenceOnly:true,separateFactInferenceUnknown:true,doNotInventMissingValues:true,sourcePacket:'STAGE_38',requiredGroundingFields:['facts','unknowns','calculations','decision','confidence','provenance'],answerStyle:'NATURAL_LANGUAGE_SYNTHESIS'};out=ctx.answerContract;break;}
