/**
 * OMEGA REASONING DISPATCHER v2.1.0
...
(function(global){'use strict';
  ...
  function compact(value,max=1400){if(value==null)return null;let s='';try{s=typeof value==='string'?value:JSON.stringify(value);}catch(_){s=String(value);}return s.length>max?s.slice(0,max)+'…':s;}
