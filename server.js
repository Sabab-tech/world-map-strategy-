...
function renderIndex(res, next) {
  fs.readFile(INDEX_PATH, 'utf8', (err, html) => {
    ...
    const scripts = [
      ...
      MINISTRY_DECISION_FRAMEWORK_SCRIPT, MINISTRY_DOMAIN_ENGINES_SCRIPT, MINISTRY_INTEROPERABILITY_SCRIPT,
      MINISTRY_RUNTIME_V1_SCRIPT, MINISTER_CAPABILITY_SCRIPT, MINISTER_STATE_SCRIPT,
