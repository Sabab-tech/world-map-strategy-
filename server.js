...
const MINISTRY_KNOWLEDGE_CONTRACT_SCRIPT = '<script src="/omega_ministry_knowledge_contract.js"></script>';
const AUTHORITATIVE_STATE_AUTHORITY_SCRIPT = '<script src="/omega_authoritative_state_authority.js"></script>';
...
function renderIndex(res, next) {
  fs.readFile(INDEX_PATH, 'utf8', (err, html) => {
    ...
    const scripts = [
      ...
      MINISTRY_REGISTRY_SCRIPT, MINISTRY_STATE_PROVIDER_SCRIPT, MINISTRY_KNOWLEDGE_CONTRACT_SCRIPT, AUTHORITATIVE_STATE_AUTHORITY_SCRIPT,
      MINISTRY_INFORMATION_POLICY_SCRIPT, MINISTRY_DECISION_FRAMEWORK_SCRIPT, MINISTRY_STATE_TRANSACTION_SCRIPT, MINISTRY_DOMAIN_ENGINES_SCRIPT,
